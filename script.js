const comidas = ["peperoni","churrasco","groselha","lasanha","macarronada","limonada","feijoada","melancia","achocolatado","espaguete","arroz","refrigerante","pastel","pizza"
];
...
document.addEventListener("keydown", (evento) => {
  const codigo = evento.keyCode; // 65 - 90 (intervalo das letras no teclado)
  if (isLetra(codigo)) {
